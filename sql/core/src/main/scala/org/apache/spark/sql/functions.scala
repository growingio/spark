...
// scalastyle:on
  ...
  */
  /**
    ...
    * @since 1.3.0
    */
  def udf[RT: TypeTag](f: Function0[RT], refuseOptimizer: Boolean = false): UserDefinedFunction = {
    val inputTypes = Try(Nil).toOption
    UserDefinedFunction(f, ScalaReflection.schemaFor(typeTag[RT]).dataType, inputTypes, refuseOptimizer)
  }
  ...
  /**
    ...
    * @since 1.3.0
    */
  def udf[RT: TypeTag, A1: TypeTag](f: Function1[A1, RT], refuseOptimizer: Boolean = false): UserDefinedFunction = {
  ...
  /**
    ...
    * @since 1.3.0
    */
  def udf[RT: TypeTag, A1: TypeTag, A2: TypeTag](f: Function2[A1, A2, RT], refuseOptimizer: Boolean = false): UserDefinedFunction = {
  ...
  /**
    ...
    * @since 1.3.0
    */
  def udf[RT: TypeTag, A1: TypeTag, A2: TypeTag, A3: TypeTag](f: Function3[A1, A2, A3, RT], refuseOptimizer: Boolean = false): UserDefinedFunction = {
  ...
  /**
    ...
    * @since 1.3.0
    */
  def udf[RT: TypeTag, A1: TypeTag, A2: TypeTag, A3: TypeTag, A4: TypeTag](f: Function4[A1, A2, A3, A4, RT], refuseOptimizer: Boolean = false): UserDefinedFunction = {
  ...
  /**
    ...
    * @since 1.3.0
    */
  def udf[RT: TypeTag, A1: TypeTag, A2: TypeTag, A3: TypeTag, A4: TypeTag, A5: TypeTag](f: Function5[A1, A2, A3, A4, A5, RT], refuseOptimizer: Boolean = false): UserDefinedFunction = {
  ...
  /**
    ...
    * @since 1.3.0
    */
  def udf[RT: TypeTag, A1: TypeTag, A2: TypeTag, A3: TypeTag, A4: TypeTag, A5: TypeTag, A6: TypeTag](f: Function6[A1, A2, A3, A4, A5, A6, RT], refuseOptimizer: Boolean = false): UserDefinedFunction = {
  ...
  /**
    ...
    * @since 1.3.0
    */
  def udf[RT: TypeTag, A1: TypeTag, A2: TypeTag, A3: TypeTag, A4: TypeTag, A5: TypeTag, A6: TypeTag, A7: TypeTag](f: Function7[A1, A2, A3, A4, A5, A6, A7, RT], refuseOptimizer: Boolean = false): UserDefinedFunction = {
  ...
  /**
    ...
    * @since 1.3.0
    */
  def udf[RT: TypeTag, A1: TypeTag, A2: TypeTag, A3: TypeTag, A4: TypeTag, A5: TypeTag, A6: TypeTag, A7: TypeTag, A8: TypeTag](f: Function8[A1, A2, A3, A4, A5, A6, A7, A8, RT], refuseOptimizer: Boolean = false): UserDefinedFunction = {
  ...
  /**
    ...
    * @since 1.3.0
    */
  def udf[RT: TypeTag, A1: TypeTag, A2: TypeTag, A3: TypeTag, A4: TypeTag, A5: TypeTag, A6: TypeTag, A7: TypeTag, A8: TypeTag, A9: TypeTag](f: Function9[A1, A2, A3, A4, A5, A6, A7, A8, A9, RT], refuseOptimizer: Boolean = false): UserDefinedFunction = {
  ...
  /**
    ...
    * @since 1.3.0
    */
  def udf[RT: TypeTag, A1: TypeTag, A2: TypeTag, A3: TypeTag, A4: TypeTag, A5: TypeTag, A6: TypeTag, A7: TypeTag, A8: TypeTag, A9: TypeTag, A10: TypeTag](f: Function10[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, RT], refuseOptimizer: Boolean = false): UserDefinedFunction = {
